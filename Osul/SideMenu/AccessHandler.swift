...
class AttachmentHandler: NSObject{
    ...
    var imagePickedBlock: ((NSURL, Data, UIImage ) -> Void)?
   ...
   //     static let alertForVideoLibraryMessage = "App does not have access to your video. To enable access, tap settings and turn on Video Library Access."
    ...
    func showAttachmentActionSheet(vc: UIViewController , sender : UIButton) {
        currentVC = vc
...
//        }))
      ...
      //  self.presentViewController(actionSheet, animated: true, completion: nil)
        ...
        func showAttachmentActionSheet2(vc: UIViewController , sender : UIButton) {
            currentVC = vc
            let actionSheet = UIAlertController(title: Constants.actionFileTypeHeading, message: Constants.actionFileTypeDescription, preferredStyle: .actionSheet)
//            
//            actionSheet.addAction(UIAlertAction(title: Constants.camera, style: .default, handler: { (action) -> Void in
...
extension AttachmentHandler: UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    @objc func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let imgUrl = info[UIImagePickerController.InfoKey.imageURL] as? URL{
            ...
            self.imagePickedBlock?(photoURL , data , image)
               print(photoURL)
